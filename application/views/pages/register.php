		...
		<div class="form-login">
			...
			<form action="" method="post" autocomplete="on" target="_top" accept-charset="utf-8">
				<div class="form-group">
                    ...
                    <img src="<?php echo base_url();?>images/tooltip.ico" title="Be creative" alt="Be creative"/>
                    <input class="form-control input-sm chat-input" name="username" id="username" type="text">
				</div>
				<div class="form-group">
					<label for = "email"><?php echo lang("email"); ?>:</label>
                    <img src="<?php echo base_url();?>images/tooltip.ico" title="10 minute email is fine" alt="10 minute email is fine"/>
					<input class="form-control input-sm chat-input" name="email" id="email" type="text">
				</div>
				<div class="form-group">
					<label for = "password"><?php echo lang("password"); ?>:</label>
					<label for = "password">Password: </label>
                    <img src="<?php echo base_url();?>images/tooltip.ico" title="minimum 6 characters" alt="minimum 6 characters"/>
